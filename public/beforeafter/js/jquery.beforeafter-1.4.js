	...
	$.fn.extend({
		beforeAfter: function(options)
		{
			var defaults =
			{
				...
				introPosition : .5,
				showFullLinks : true,
				beforeLinkText: lang == 'fr' ? 'Afficher seulement avant' : 'Show only before',
				afterLinkText: lang == 'fr' ? 'Afficher seulement apr&#232;s' : 'Show only after',
				imagePath : 'http://ville.montreal.qc.ca/pls/portal/docs/page/lib_fr/media/images/public/',
				cursor: 'pointer',
				clickSpeed: 600,
